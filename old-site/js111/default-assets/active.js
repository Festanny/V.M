(function ($) {
    ...
    // ****************************
    if ($.fn.imagesLoaded) {
        $('.vm-portfolio-area, .vm-blog-masonary').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.vm-portfolio-area, .vm-blog-masonary').isotope({
                itemSelector: '.vm-portfolio-item, .vm-blog-masonary-item',
                percentPosition: true,
                masonry: {
                    columnWidth: '.vm-portfolio-item, .vm-blog-masonary-item'
                }
            });
        });
    }
